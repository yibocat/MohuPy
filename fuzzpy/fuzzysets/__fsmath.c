...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "fuzzpy.fuzzysets.__fsmath",
        "sources": [
            "fuzzpy/fuzzysets/__fsmath.pyx"
        ]
    },
    "module_name": "fuzzpy.fuzzysets.__fsmath"
}
END: Cython Metadata */
...
#define __PYX_HAVE__fuzzpy__fuzzysets____fsmath
#define __PYX_HAVE_API__fuzzpy__fuzzysets____fsmath
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* "fuzzpy/fuzzysets/__fsmath.pxd":11
 * cimport numpy as np
 * 
...
/* "fuzzpy/fuzzysets/__fsmath.pxd":12
 * 
 * cpdef __dot11(np.ndarray x, np.ndarray y, str norm=*)
 * cpdef __dot21(np.ndarray x, np.ndarray y, str norm=*)             # <<<<<<<<<<<<<<
 * cpdef __dot12(np.ndarray x, np.ndarray y, str norm=*)
...
/* "fuzzpy/fuzzysets/__fsmath.pxd":13
 * cpdef __dot11(np.ndarray x, np.ndarray y, str norm=*)
 * cpdef __dot21(np.ndarray x, np.ndarray y, str norm=*)
 * cpdef __dot12(np.ndarray x, np.ndarray y, str norm=*)             # <<<<<<<<<<<<<<
 * cpdef __dot22(np.ndarray x, np.ndarray y, str norm=*)
...
/* "fuzzpy/fuzzysets/__fsmath.pxd":14
 * cpdef __dot21(np.ndarray x, np.ndarray y, str norm=*)
 * cpdef __dot12(np.ndarray x, np.ndarray y, str norm=*)
 * cpdef __dot22(np.ndarray x, np.ndarray y, str norm=*)             # <<<<<<<<<<<<<<
 */
...
#define __Pyx_MODULE_NAME "fuzzpy.fuzzysets.__fsmath"
extern int __pyx_module_is_main_fuzzpy__fuzzysets____fsmath;
int __pyx_module_is_main_fuzzpy__fuzzysets____fsmath = 0;

/* Implementation of "fuzzpy.fuzzysets.__fsmath" */
...
static const char __pyx_k_fuzzpy_fuzzysets___fsmath[] = "fuzzpy.fuzzysets.__fsmath";
static const char __pyx_k_fuzzpy_fuzzysets___fsmath_pyx[] = "fuzzpy/fuzzysets/__fsmath.pyx";
...
static PyObject *__pyx_n_s_fuzzpy_fuzzysets___fsmath;
static PyObject *__pyx_kp_s_fuzzpy_fuzzysets___fsmath_pyx;
...
#endif
/* #### Code section: decls ### */
static PyObject *__pyx_pf_6fuzzpy_9fuzzysets_8__fsmath___dot11(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_x, PyArrayObject *__pyx_v_y, PyObject *__pyx_v_norm); /* proto */
static PyObject *__pyx_pf_6fuzzpy_9fuzzysets_8__fsmath_2__dot21(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_x, PyArrayObject *__pyx_v_y, PyObject *__pyx_v_norm); /* proto */
static PyObject *__pyx_pf_6fuzzpy_9fuzzysets_8__fsmath_4__dot12(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_x, PyArrayObject *__pyx_v_y, PyObject *__pyx_v_norm); /* proto */
static PyObject *__pyx_pf_6fuzzpy_9fuzzysets_8__fsmath_6__dot22(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_x, PyArrayObject *__pyx_v_y, PyObject *__pyx_v_norm); /* proto */
#if !CYTHON_USE_MODULE_STATE
...
typedef struct {
  ...
  PyObject *__pyx_n_s_fuzzpy_fuzzysets___fsmath;
  PyObject *__pyx_kp_s_fuzzpy_fuzzysets___fsmath_pyx;
...
static int __pyx_m_clear(PyObject *m) {
  ...
  Py_CLEAR(clear_module_state->__pyx_n_s_fuzzpy_fuzzysets___fsmath);
  Py_CLEAR(clear_module_state->__pyx_kp_s_fuzzpy_fuzzysets___fsmath_pyx);
...
static int __pyx_m_traverse(PyObject *m, visitproc visit, void *arg) {
  ...
  Py_VISIT(traverse_module_state->__pyx_n_s_fuzzpy_fuzzysets___fsmath);
  Py_VISIT(traverse_module_state->__pyx_kp_s_fuzzpy_fuzzysets___fsmath_pyx);
...
#define __pyx_n_s_fuzzpy_fuzzysets___fsmath __pyx_mstate_global->__pyx_n_s_fuzzpy_fuzzysets___fsmath
#define __pyx_kp_s_fuzzpy_fuzzysets___fsmath_pyx __pyx_mstate_global->__pyx_kp_s_fuzzpy_fuzzysets___fsmath_pyx
...
/* "fuzzpy/fuzzysets/__fsmath.pyx":15
 * d = fns.get_dict
 * 
...
static PyObject *__pyx_pw_6fuzzpy_9fuzzysets_8__fsmath_1__dot11(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static PyObject *__pyx_f_6fuzzpy_9fuzzysets_8__fsmath___dot11(PyArrayObject *__pyx_v_x, PyArrayObject *__pyx_v_y, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_6fuzzpy_9fuzzysets_8__fsmath___dot11 *__pyx_optional_args) {
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":16
 * 
 * cpdef __dot11(np.ndarray x, np.ndarray y, str norm='algeb'):
 *     assert x[0].__class__ == y[0].__class__, 'ERROR: the two fuzzy set are not the same set!'             # <<<<<<<<<<<<<<
 *     assert x[0].qrung == y[0].qrung, 'ERROR: the qrung of two fuzzy sets are not equal!'
 ...
 */
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":17
 * cpdef __dot11(np.ndarray x, np.ndarray y, str norm='algeb'):
 *     assert x[0].__class__ == y[0].__class__, 'ERROR: the two fuzzy set are not the same set!'
 *     assert x[0].qrung == y[0].qrung, 'ERROR: the qrung of two fuzzy sets are not equal!'             # <<<<<<<<<<<<<<
 *     assert x.ndim == 1 and x.ndim == 1, 'Both fuzzy sets must be 1-dimensional fuzzy sets.'
 ...
 */
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":18
 *     assert x[0].__class__ == y[0].__class__, 'ERROR: the two fuzzy set are not the same set!'
 *     assert x[0].qrung == y[0].qrung, 'ERROR: the qrung of two fuzzy sets are not equal!'
 *     assert x.ndim == 1 and x.ndim == 1, 'Both fuzzy sets must be 1-dimensional fuzzy sets.'             # <<<<<<<<<<<<<<
 *     assert x.size == y.size, 'ERROR: The number of elements in the two fuzzy sets must be the same.'
 ...
 */
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":19
 *     assert x[0].qrung == y[0].qrung, 'ERROR: the qrung of two fuzzy sets are not equal!'
 *     assert x.ndim == 1 and x.ndim == 1, 'Both fuzzy sets must be 1-dimensional fuzzy sets.'
 *     assert x.size == y.size, 'ERROR: The number of elements in the two fuzzy sets must be the same.'             # <<<<<<<<<<<<<<
 *     cdef int num
 ...
 */
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":22
 *     cdef int num
 * 
 *     nor = norm + '_multiply'             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":23
 * 
 *     nor = norm + '_multiply'
 *     assert nor in d[x[0].__class__.__name__], 'KetError: The norm {} is not defined.'.format(nor)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":25
 *     assert nor in d[x[0].__class__.__name__], 'KetError: The norm {} is not defined.'.format(nor)
 * 
 *     multipy = d[x[0].__class__.__name__][nor]             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":26
 * 
 *     multipy = d[x[0].__class__.__name__][nor]
 *     newfuzz = fuzzyset(x[0].qrung, y[0].__class__.__name__)             # <<<<<<<<<<<<<<
 *     num = 0
 ...
 */
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":27
 *     multipy = d[x[0].__class__.__name__][nor]
 *     newfuzz = fuzzyset(x[0].qrung, y[0].__class__.__name__)
 *     num = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":29
 *     num = 0
 * 
 *     for i in range(len(x)):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
    ...
    /* "fuzzpy/fuzzysets/__fsmath.pyx":30
 * 
 *     for i in range(len(x)):
 *         newfuzz.append(multipy(x[i], y[i]))             # <<<<<<<<<<<<<<
 *         num += 1
 ...
 */
    ...
    /* "fuzzpy/fuzzysets/__fsmath.pyx":31
 *     for i in range(len(x)):
 *         newfuzz.append(multipy(x[i], y[i]))
 *         num += 1             # <<<<<<<<<<<<<<
 *     f = newfuzz.sum()
 ...
 */
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":32
 *         newfuzz.append(multipy(x[i], y[i]))
 *         num += 1
 *     f = newfuzz.sum()             # <<<<<<<<<<<<<<
 *     newfuzz.clear()
 ...
 */
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":33
 *         num += 1
 *     f = newfuzz.sum()
 *     newfuzz.clear()             # <<<<<<<<<<<<<<
 *     newfuzz.append(f)
 ...
 */
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":34
 *     f = newfuzz.sum()
 *     newfuzz.clear()
 *     newfuzz.append(f)             # <<<<<<<<<<<<<<
 *     return newfuzz
 ...
 */
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":35
 *     newfuzz.clear()
 *     newfuzz.append(f)
 *     return newfuzz             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("fuzzpy.fuzzysets.__fsmath.__dot11", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
static PyMethodDef __pyx_mdef_6fuzzpy_9fuzzysets_8__fsmath_1__dot11 = {"__dot11", (PyCFunction)(void*)(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_6fuzzpy_9fuzzysets_8__fsmath_1__dot11, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_6fuzzpy_9fuzzysets_8__fsmath_1__dot11(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_r = __pyx_pf_6fuzzpy_9fuzzysets_8__fsmath___dot11(__pyx_self, __pyx_v_x, __pyx_v_y, __pyx_v_norm);
...
static PyObject *__pyx_pf_6fuzzpy_9fuzzysets_8__fsmath___dot11(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_x, PyArrayObject *__pyx_v_y, PyObject *__pyx_v_norm) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  struct __pyx_opt_args_6fuzzpy_9fuzzysets_8__fsmath___dot11 __pyx_t_2;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("__dot11", 0);
  ...
  __pyx_t_1 = __pyx_f_6fuzzpy_9fuzzysets_8__fsmath___dot11(__pyx_v_x, __pyx_v_y, 0, &__pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "fuzzpy/fuzzysets/__fsmath.pyx":37
 *     return newfuzz
 * 
 * cpdef __dot21(np.ndarray x, np.ndarray y, str norm='algeb'):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pw_6fuzzpy_9fuzzysets_8__fsmath_3__dot21(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
...
static PyObject *__pyx_f_6fuzzpy_9fuzzysets_8__fsmath___dot21(PyArrayObject *__pyx_v_x, PyArrayObject *__pyx_v_y, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_6fuzzpy_9fuzzysets_8__fsmath___dot21 *__pyx_optional_args) {
  PyObject *__pyx_v_norm = ((PyObject*)__pyx_n_u_algeb);
  ...
  int __pyx_t_10;
  Py_ssize_t __pyx_t_11;
  struct __pyx_opt_args_6fuzzpy_9fuzzysets_8__fsmath___dot11 __pyx_t_12;
  int __pyx_t_13;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":38
 * 
 * cpdef __dot21(np.ndarray x, np.ndarray y, str norm='algeb'):
 *     assert x[0, 0].__class__ == y[0].__class__, 'ERROR: the two fuzzy set are not the same set!'             # <<<<<<<<<<<<<<
 *     assert x[0, 0].qrung == y[0].qrung, 'ERROR: the qrung of two fuzzy sets are not equal!'
 ...
 */
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":39
 * cpdef __dot21(np.ndarray x, np.ndarray y, str norm='algeb'):
 *     assert x[0, 0].__class__ == y[0].__class__, 'ERROR: the two fuzzy set are not the same set!'
 *     assert x[0, 0].qrung == y[0].qrung, 'ERROR: the qrung of two fuzzy sets are not equal!'             # <<<<<<<<<<<<<<
 *     assert x.ndim == 2 and y.ndim == 1, \
 ...
 */
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":40
 *     assert x[0, 0].__class__ == y[0].__class__, 'ERROR: the two fuzzy set are not the same set!'
 *     assert x[0, 0].qrung == y[0].qrung, 'ERROR: the qrung of two fuzzy sets are not equal!'
 *     assert x.ndim == 2 and y.ndim == 1, \             # <<<<<<<<<<<<<<
 *         'The first set must be 2-dimensional and the second set must be 1-dimensional'
 ...
 */
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":42
 *     assert x.ndim == 2 and y.ndim == 1, \
 *         'The first set must be 2-dimensional and the second set must be 1-dimensional'
 *     assert len(x[0]) == len(y), 'Shape of two set are not aligned.'             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":44
 *     assert len(x[0]) == len(y), 'Shape of two set are not aligned.'
 * 
 *     newf = fuzzyset(x[0, 0].qrung, y[0].__class__.__name__)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":46
 *     newf = fuzzyset(x[0, 0].qrung, y[0].__class__.__name__)
 * 
 *     for i in range(len(x)):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_6; __pyx_t_11+=1) {
    ...
    /* "fuzzpy/fuzzysets/__fsmath.pyx":47
 * 
 *     for i in range(len(x)):
 *         newf.append(__dot11(x[i, :], y, norm).set[0])             # <<<<<<<<<<<<<<
 *     return newf
 ...
 */
    ...
    __pyx_t_2 = __pyx_f_6fuzzpy_9fuzzysets_8__fsmath___dot11(((PyArrayObject *)__pyx_t_1), __pyx_v_y, 0, &__pyx_t_12); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 47, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":48
 *     for i in range(len(x)):
 *         newf.append(__dot11(x[i, :], y, norm).set[0])
 *     return newf             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("fuzzpy.fuzzysets.__fsmath.__dot21", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
static PyMethodDef __pyx_mdef_6fuzzpy_9fuzzysets_8__fsmath_3__dot21 = {"__dot21", (PyCFunction)(void*)(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_6fuzzpy_9fuzzysets_8__fsmath_3__dot21, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_6fuzzpy_9fuzzysets_8__fsmath_3__dot21(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_r = __pyx_pf_6fuzzpy_9fuzzysets_8__fsmath_2__dot21(__pyx_self, __pyx_v_x, __pyx_v_y, __pyx_v_norm);
...
static PyObject *__pyx_pf_6fuzzpy_9fuzzysets_8__fsmath_2__dot21(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_x, PyArrayObject *__pyx_v_y, PyObject *__pyx_v_norm) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  struct __pyx_opt_args_6fuzzpy_9fuzzysets_8__fsmath___dot21 __pyx_t_2;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("__dot21", 0);
  ...
  __pyx_t_2.__pyx_n = 1;
  __pyx_t_2.norm = __pyx_v_norm;
  __pyx_t_1 = __pyx_f_6fuzzpy_9fuzzysets_8__fsmath___dot21(__pyx_v_x, __pyx_v_y, 0, &__pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "fuzzpy/fuzzysets/__fsmath.pyx":50
 *     return newf
 * 
 * cpdef __dot12(np.ndarray x, np.ndarray y, str norm='algeb'):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pw_6fuzzpy_9fuzzysets_8__fsmath_5__dot12(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
...
static PyObject *__pyx_f_6fuzzpy_9fuzzysets_8__fsmath___dot12(PyArrayObject *__pyx_v_x, PyArrayObject *__pyx_v_y, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_6fuzzpy_9fuzzysets_8__fsmath___dot12 *__pyx_optional_args) {
  PyObject *__pyx_v_norm = ((PyObject*)__pyx_n_u_algeb);
  PyObject *__pyx_v_newf = NULL;
  Py_ssize_t __pyx_v_i;
  PyObject *__pyx_r = NULL;
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":51
 * 
 * cpdef __dot12(np.ndarray x, np.ndarray y, str norm='algeb'):
 *     assert x[0].__class__ == y[0, 0].__class__, 'ERROR: the two fuzzy set are not the same set!'             # <<<<<<<<<<<<<<
 *     assert x[0].qrung == y[0, 0].qrung, 'ERROR: the qrung of two fuzzy sets are not equal!'
 ...
 */
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":52
 * cpdef __dot12(np.ndarray x, np.ndarray y, str norm='algeb'):
 *     assert x[0].__class__ == y[0, 0].__class__, 'ERROR: the two fuzzy set are not the same set!'
 *     assert x[0].qrung == y[0, 0].qrung, 'ERROR: the qrung of two fuzzy sets are not equal!'             # <<<<<<<<<<<<<<
 *     assert x.ndim == 1 and y.ndim == 2, 'The first set must be 1-dimensional and the second set must be 2-dimensional'
 ...
 */
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":53
 *     assert x[0].__class__ == y[0, 0].__class__, 'ERROR: the two fuzzy set are not the same set!'
 *     assert x[0].qrung == y[0, 0].qrung, 'ERROR: the qrung of two fuzzy sets are not equal!'
 *     assert x.ndim == 1 and y.ndim == 2, 'The first set must be 1-dimensional and the second set must be 2-dimensional'             # <<<<<<<<<<<<<<
 *     assert len(x) == len(y), 'Shape of two set are not aligned.'
 ...
 */
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":54
 *     assert x[0].qrung == y[0, 0].qrung, 'ERROR: the qrung of two fuzzy sets are not equal!'
 *     assert x.ndim == 1 and y.ndim == 2, 'The first set must be 1-dimensional and the second set must be 2-dimensional'
 *     assert len(x) == len(y), 'Shape of two set are not aligned.'             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":56
 *     assert len(x) == len(y), 'Shape of two set are not aligned.'
 * 
 *     newf = fuzzyset(x[0].qrung, y[0, 0].__class__.__name__)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":58
 *     newf = fuzzyset(x[0].qrung, y[0, 0].__class__.__name__)
 * 
 *     for i in range(len(y[0])):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_6; __pyx_t_11+=1) {
    ...
    /* "fuzzpy/fuzzysets/__fsmath.pyx":59
 * 
 *     for i in range(len(y[0])):
 *         newf.append(__dot11(x, y[:, i], norm).set[0])             # <<<<<<<<<<<<<<
 *     return newf
 ...
 */
    ...
    __pyx_t_12.__pyx_n = 1;
    __pyx_t_12.norm = __pyx_v_norm;
    __pyx_t_2 = __pyx_f_6fuzzpy_9fuzzysets_8__fsmath___dot11(__pyx_v_x, ((PyArrayObject *)__pyx_t_1), 0, &__pyx_t_12); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 59, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":60
 *     for i in range(len(y[0])):
 *         newf.append(__dot11(x, y[:, i], norm).set[0])
 *     return newf             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_8);
  __Pyx_XDECREF(__pyx_t_9);
  __Pyx_AddTraceback("fuzzpy.fuzzysets.__fsmath.__dot12", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_newf);
  __Pyx_XGIVEREF(__pyx_r);
...
static PyMethodDef __pyx_mdef_6fuzzpy_9fuzzysets_8__fsmath_5__dot12 = {"__dot12", (PyCFunction)(void*)(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_6fuzzpy_9fuzzysets_8__fsmath_5__dot12, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_6fuzzpy_9fuzzysets_8__fsmath_5__dot12(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_r = __pyx_pf_6fuzzpy_9fuzzysets_8__fsmath_4__dot12(__pyx_self, __pyx_v_x, __pyx_v_y, __pyx_v_norm);
...
static PyObject *__pyx_pf_6fuzzpy_9fuzzysets_8__fsmath_4__dot12(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_x, PyArrayObject *__pyx_v_y, PyObject *__pyx_v_norm) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  struct __pyx_opt_args_6fuzzpy_9fuzzysets_8__fsmath___dot12 __pyx_t_2;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("__dot12", 0);
  ...
  __pyx_t_2.__pyx_n = 1;
  __pyx_t_2.norm = __pyx_v_norm;
  __pyx_t_1 = __pyx_f_6fuzzpy_9fuzzysets_8__fsmath___dot12(__pyx_v_x, __pyx_v_y, 0, &__pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 50, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "fuzzpy/fuzzysets/__fsmath.pyx":62
 *     return newf
 * 
 * cpdef __dot22(np.ndarray x, np.ndarray y, str norm='algeb'):             # <<<<<<<<<<<<<<
 *     """
...
static PyObject *__pyx_pw_6fuzzpy_9fuzzysets_8__fsmath_7__dot22(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
...
static PyObject *__pyx_f_6fuzzpy_9fuzzysets_8__fsmath___dot22(PyArrayObject *__pyx_v_x, PyArrayObject *__pyx_v_y, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_6fuzzpy_9fuzzysets_8__fsmath___dot22 *__pyx_optional_args) {
  PyObject *__pyx_v_norm = ((PyObject*)__pyx_n_u_algeb);
  PyObject *__pyx_v_newf = NULL;
  Py_ssize_t __pyx_v_i;
  ...
  struct __pyx_opt_args_6fuzzpy_9fuzzysets_8__fsmath___dot11 __pyx_t_15;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":66
 *         Dot product of two fuzzy sets
 *     """
 ...
 */
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":67
 *     """
 *     assert x[0, 0].__class__ == y[0, 0].__class__, 'ERROR: the two fuzzy set are not the same set!'
 *     assert x[0, 0].qrung == y[0, 0].qrung, 'ERROR: the qrung of two fuzzy sets are not equal!'             # <<<<<<<<<<<<<<
 *     assert x.ndim == 2 and y.ndim == 2, 'Fuzzy sets must be 2-dimensional.'
 ...
 */
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":68
 *     assert x[0, 0].__class__ == y[0, 0].__class__, 'ERROR: the two fuzzy set are not the same set!'
 *     assert x[0, 0].qrung == y[0, 0].qrung, 'ERROR: the qrung of two fuzzy sets are not equal!'
 *     assert x.ndim == 2 and y.ndim == 2, 'Fuzzy sets must be 2-dimensional.'             # <<<<<<<<<<<<<<
 *     assert len(x[0]) == len(y), 'Shape of two set are not aligned.'
 ...
 */
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":69
 *     assert x[0, 0].qrung == y[0, 0].qrung, 'ERROR: the qrung of two fuzzy sets are not equal!'
 *     assert x.ndim == 2 and y.ndim == 2, 'Fuzzy sets must be 2-dimensional.'
 *     assert len(x[0]) == len(y), 'Shape of two set are not aligned.'             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":71
 *     assert len(x[0]) == len(y), 'Shape of two set are not aligned.'
 * 
 *     newf = fuzzyset(x[0, 0].qrung, y[0, 0].__class__.__name__)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":72
 * 
 *     newf = fuzzyset(x[0, 0].qrung, y[0, 0].__class__.__name__)
 *     newf.zeros(len(x), len(y[0]))             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":74
 *     newf.zeros(len(x), len(y[0]))
 * 
 *     for i in range(len(x)):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_6; __pyx_t_11+=1) {
    ...
    /* "fuzzpy/fuzzysets/__fsmath.pyx":75
 * 
 *     for i in range(len(x)):
 *         for j in range(len(y[0])):             # <<<<<<<<<<<<<<
 *             newf.set[i, j] = __dot11(x[i, :], y[:, j], norm=norm).set[0]
 ...
 */
    ...
    for (__pyx_t_14 = 0; __pyx_t_14 < __pyx_t_13; __pyx_t_14+=1) {
      ...
      /* "fuzzpy/fuzzysets/__fsmath.pyx":76
 *     for i in range(len(x)):
 *         for j in range(len(y[0])):
 *             newf.set[i, j] = __dot11(x[i, :], y[:, j], norm=norm).set[0]             # <<<<<<<<<<<<<<
 *     return newf
 ...
 */
      ...
      __pyx_t_8 = __pyx_f_6fuzzpy_9fuzzysets_8__fsmath___dot11(((PyArrayObject *)__pyx_t_1), ((PyArrayObject *)__pyx_t_2), 0, &__pyx_t_15); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 76, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_8);
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":77
 *         for j in range(len(y[0])):
 *             newf.set[i, j] = __dot11(x[i, :], y[:, j], norm=norm).set[0]
 *     return newf             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_8);
  __Pyx_XDECREF(__pyx_t_9);
  __Pyx_AddTraceback("fuzzpy.fuzzysets.__fsmath.__dot22", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_newf);
  __Pyx_XGIVEREF(__pyx_r);
...
PyDoc_STRVAR(__pyx_doc_6fuzzpy_9fuzzysets_8__fsmath_6__dot22, "\n        Dot product of two fuzzy sets\n    ");
static PyMethodDef __pyx_mdef_6fuzzpy_9fuzzysets_8__fsmath_7__dot22 = {"__dot22", (PyCFunction)(void*)(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_6fuzzpy_9fuzzysets_8__fsmath_7__dot22, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_6fuzzpy_9fuzzysets_8__fsmath_6__dot22};
static PyObject *__pyx_pw_6fuzzpy_9fuzzysets_8__fsmath_7__dot22(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_r = __pyx_pf_6fuzzpy_9fuzzysets_8__fsmath_6__dot22(__pyx_self, __pyx_v_x, __pyx_v_y, __pyx_v_norm);
...
static PyObject *__pyx_pf_6fuzzpy_9fuzzysets_8__fsmath_6__dot22(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_x, PyArrayObject *__pyx_v_y, PyObject *__pyx_v_norm) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  struct __pyx_opt_args_6fuzzpy_9fuzzysets_8__fsmath___dot22 __pyx_t_2;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("__dot22", 0);
  ...
  __pyx_t_2.__pyx_n = 1;
  __pyx_t_2.norm = __pyx_v_norm;
  __pyx_t_1 = __pyx_f_6fuzzpy_9fuzzysets_8__fsmath___dot22(__pyx_v_x, __pyx_v_y, 0, &__pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 62, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {0, __pyx_k_fuzzpy_fuzzysets___fsmath, sizeof(__pyx_k_fuzzpy_fuzzysets___fsmath), 0, 0, 1, 1},
  {0, __pyx_k_fuzzpy_fuzzysets___fsmath_pyx, sizeof(__pyx_k_fuzzpy_fuzzysets___fsmath_pyx), 0, 0, 1, 0},
  ...
  {&__pyx_n_s_fuzzpy_fuzzysets___fsmath, __pyx_k_fuzzpy_fuzzysets___fsmath, sizeof(__pyx_k_fuzzpy_fuzzysets___fsmath), 0, 0, 1, 1},
  {&__pyx_kp_s_fuzzpy_fuzzysets___fsmath_pyx, __pyx_k_fuzzpy_fuzzysets___fsmath_pyx, sizeof(__pyx_k_fuzzpy_fuzzysets___fsmath_pyx), 0, 0, 1, 0},
 ...
 */
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":12
 * 
 ...
 * 
 */
  __pyx_tuple__7 = PyTuple_Pack(2, __pyx_n_s_fuzzpy, __pyx_n_s_fuzzynumbers); if (unlikely(!__pyx_tuple__7)) __PYX_ERR(0, 12, __pyx_L1_error)
 ...
 */
  ...
  __pyx_codeobj__9 = (PyObject*)__Pyx_PyCode_New(3, 0, 0, 3, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__8, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_fuzzpy_fuzzysets___fsmath_pyx, __pyx_n_s_dot11, 15, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__9)) __PYX_ERR(0, 15, __pyx_L1_error)
 ...
 *         Dot product of two fuzzy sets
 */
  __pyx_codeobj__15 = (PyObject*)__Pyx_PyCode_New(3, 0, 0, 3, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__8, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_fuzzpy_fuzzysets___fsmath_pyx, __pyx_n_s_dot22, 62, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__15)) __PYX_ERR(0, 62, __pyx_L1_error)
...
static CYTHON_SMALL_CODE int __Pyx_InitConstants(void) {
  ...
  if (__Pyx_InitString(__pyx_string_tab[22], &__pyx_n_s_dot11) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  ...
  if (__Pyx_InitString(__pyx_string_tab[28], &__pyx_n_s_fuzzpy) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  if (__Pyx_InitString(__pyx_string_tab[29], &__pyx_n_s_fuzzpy_fuzzynumbers) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  if (__Pyx_InitString(__pyx_string_tab[30], &__pyx_n_s_fuzzpy_fuzzysets___fsmath) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  if (__Pyx_InitString(__pyx_string_tab[31], &__pyx_kp_s_fuzzpy_fuzzysets___fsmath_pyx) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  if (__Pyx_InitString(__pyx_string_tab[32], &__pyx_n_s_fuzzynumbers) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  if (__Pyx_InitString(__pyx_string_tab[33], &__pyx_n_s_fuzzyset) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  if (__Pyx_InitString(__pyx_string_tab[34], &__pyx_n_s_get_dict) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("__dot11", (void (*)(void))__pyx_f_6fuzzpy_9fuzzysets_8__fsmath___dot11, "PyObject *(PyArrayObject *, PyArrayObject *, int __pyx_skip_dispatch, struct __pyx_opt_args_6fuzzpy_9fuzzysets_8__fsmath___dot11 *__pyx_optional_args)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("__dot21", (void (*)(void))__pyx_f_6fuzzpy_9fuzzysets_8__fsmath___dot21, "PyObject *(PyArrayObject *, PyArrayObject *, int __pyx_skip_dispatch, struct __pyx_opt_args_6fuzzpy_9fuzzysets_8__fsmath___dot21 *__pyx_optional_args)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("__dot12", (void (*)(void))__pyx_f_6fuzzpy_9fuzzysets_8__fsmath___dot12, "PyObject *(PyArrayObject *, PyArrayObject *, int __pyx_skip_dispatch, struct __pyx_opt_args_6fuzzpy_9fuzzysets_8__fsmath___dot12 *__pyx_optional_args)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("__dot22", (void (*)(void))__pyx_f_6fuzzpy_9fuzzysets_8__fsmath___dot22, "PyObject *(PyArrayObject *, PyArrayObject *, int __pyx_skip_dispatch, struct __pyx_opt_args_6fuzzpy_9fuzzysets_8__fsmath___dot22 *__pyx_optional_args)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_fuzzpy__fuzzysets____fsmath) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "fuzzpy.fuzzysets.__fsmath")) {
      if (unlikely((PyDict_SetItemString(modules, "fuzzpy.fuzzysets.__fsmath", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":8
 * #  Software: fuzzpy
 * 
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 ...
 */
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":11
 * cimport numpy as np
 * 
 * from .fuzzyset import fuzzyset             # <<<<<<<<<<<<<<
 * import fuzzpy.fuzzynumbers as fns
 ...
 * 
 */
  __pyx_t_3 = __Pyx_ImportDottedModule(__pyx_n_s_fuzzpy_fuzzynumbers, __pyx_tuple__7); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_fns, __pyx_t_3) < 0) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;

  /* "fuzzpy/fuzzysets/__fsmath.pyx":13
 * from .fuzzyset import fuzzyset
 * import fuzzpy.fuzzynumbers as fns
 * d = fns.get_dict             # <<<<<<<<<<<<<<
 * 
 ...
 *     assert x[0].qrung == y[0].qrung, 'ERROR: the qrung of two fuzzy sets are not equal!'
 */
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_6fuzzpy_9fuzzysets_8__fsmath_1__dot11, 0, __pyx_n_s_dot11, NULL, __pyx_n_s_fuzzpy_fuzzysets___fsmath, __pyx_d, ((PyObject *)__pyx_codeobj__9)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 *     assert x[0, 0].qrung == y[0].qrung, 'ERROR: the qrung of two fuzzy sets are not equal!'
 */
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_6fuzzpy_9fuzzysets_8__fsmath_3__dot21, 0, __pyx_n_s_dot21, NULL, __pyx_n_s_fuzzpy_fuzzysets___fsmath, __pyx_d, ((PyObject *)__pyx_codeobj__11)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 *     assert x[0].qrung == y[0, 0].qrung, 'ERROR: the qrung of two fuzzy sets are not equal!'
 */
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_6fuzzpy_9fuzzysets_8__fsmath_5__dot12, 0, __pyx_n_s_dot12, NULL, __pyx_n_s_fuzzpy_fuzzysets___fsmath, __pyx_d, ((PyObject *)__pyx_codeobj__13)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 50, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 *         Dot product of two fuzzy sets
 */
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_6fuzzpy_9fuzzysets_8__fsmath_7__dot22, 0, __pyx_n_s_dot22, NULL, __pyx_n_s_fuzzpy_fuzzysets___fsmath, __pyx_d, ((PyObject *)__pyx_codeobj__15)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 62, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  /* "fuzzpy/fuzzysets/__fsmath.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init fuzzpy.fuzzysets.__fsmath", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #endif
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init fuzzpy.fuzzysets.__fsmath");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
