...
d = {
    'qrunghfe': {
        ...
        'algeb_multipy': fuzzyelement.DHFElements.algeb_multipy,
        'algeb_plus': fuzzyelement.DHFElements.algeb_plus,
        'eins_multipy': fuzzyelement.DHFElements.eins_multipy,
    ...
    'qrungfn': {
        ...
        'algeb_multipy': fuzzyelement.FNumbers.algeb_multipy,
        'algeb_plus': fuzzyelement.FNumbers.algeb_plus,
        'eins_multipy': fuzzyelement.FNumbers.eins_multipy,
    ...
    'qrungivfn': {
        ...
        'algeb_multipy': fuzzyelement.IVFNumbers.algeb_multipy,
        'algeb_plus': fuzzyelement.IVFNumbers.algeb_plus,
        'eins_multipy': fuzzyelement.IVFNumbers.eins_multipy,
