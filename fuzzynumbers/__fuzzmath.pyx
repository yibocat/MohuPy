...
cpdef _adj(np.ndarray d, double tm):
        """
...
cpdef double qdfe_d(d1: qrungdhfe, d2: qrungdhfe, double l, double t, indeterminacy=True):
    """
...
cpdef double qifn_d(d1: qrungifn, d2: qrungifn, l=1, indeterminacy=True):
    """
...
cpdef double qivfn_d(d1: qrungivfn, d2: qrungivfn, l=1, indeterminacy=True):
    """
